"""!gif <search term> return a random result from the  google all gif search result for <search term>"""
...
def gif(searchterm):
    ...
    searchurl = "https://www.google.com/search?tbs=itp:animated&tbm=isch&q={0}".format(searchterm)
